...
class Poly3(TrajectoryGenerator):
    ...
    def generate(self, t):
        ...
        q_dot = (3 * self.a_3 * t ** 2 + 2 * self.a_2 * t - 3 * self.a_2 * t ** 2 - 4 * self.a_1 * t + 3 * self.a_1
                 * t ** 2 - 3 * self.a_0 + 6 * self.a_0 * t - 3 * self.a_0 * t ** 2 + self.a_1)
        q_ddot = (6 * self.a_3 * t + 2 * self.a_2 - 6 * self.a_2 * t - 4 * self.a_1 + 6 * self.a_1 * t + 6
                  * self.a_0 - 6 * self.a_0 * t)
